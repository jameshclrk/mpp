...
#ifndef PRECISION_H
#define PRECISION_H 1

/** pseudonym for a real number MPI type. Can be set to MPI_DOUBLE or MPI_FLOAT */
#define MPI_REALNUM MPI_DOUBLE
/** pseudonym for a real number type. Can be set to either float or double */
typedef double real;
#endif
